...
<section class="messages">
   ...
   <h1 class="title"> Người dùng đang truy cập </h1>
   ...
   <div class="box">
      ...
      <p> Đang truy cập : <span><?php echo $fetch_message['message']; ?></span> </p>
      <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('delete this message?');" class="delete-btn">Chặn người dùng</a>
   </div>
   <?php
      };
   }else{
