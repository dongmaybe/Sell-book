...
<div class="heading">
   <h3>Trang Vũ Trụ</h3>
   <p> <a href="home.php">Trang chủ</a> / Vũ Trụ </p>
</div>

<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search" placeholder="Tìm sách..."style="display:none"; class="box">
   <input type="submit" name="submit" value="Hiển thị danh sách" class="btn">
   </form>
</section>
